...
Registration delay is the waiting time between when an event occurs and you getting the data.

1. A person is infected. [**The epidemiological event**]
2. The person shows symptoms. [**Date of symptoms**]
3. The person visits the doctor. [**Date of consultation**]
4. The person is sent to a phlebotomist to have their blood taken. [**Date of sample**]
5. The blood is sent to a lab.
6. The lab sends the results to the doctor.
7. The epidemiologist obtains the data from the doctor. [**You are here**]
