...
| Step | Event                                              | Type of Delay         |
|------|---------------------------------------------------|-----------------------|
| 1    | A person is infected. [**The epidemiological event**] | Start of timeline     |
| 2    | The person shows symptoms. [**Date of symptoms**] | Part of registration delay |
| 3    | The person visits the doctor. [**Date of consultation**] | Part of registration delay |
| 4    | The person is sent to a phlebotomist to have their blood taken. [**Date of sample**] | Part of registration delay |
| 5    | The blood is sent to a lab.                       | Part of registration delay |
| 6    | The lab sends the results to the doctor.          | Part of registration delay |
| 7    | The epidemiologist obtains the data from the doctor. [**You are here**] | Reporting delay        |
