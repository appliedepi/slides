...
.nota[`r paste0(mod5[mod5$uid == "mod5_fn_flextable", params$lang])`]
...
.nota[`r paste0(mod5[mod5$uid == "mod5_fn_groupby", params$lang])`]
...
???
Nota `groups: hospital`, en la parte superior del tibble
