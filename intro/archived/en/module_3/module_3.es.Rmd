---
title: Introducción a R para Epidemiología Aplicada
...
.nota\[`r paste0(mod3[mod3$uid == "mod3_fn_dplyR", params$lang])`\]
...
## .nota\[`r paste0(mod3[mod3$uid == "mod3_fn_filter", params$lang])`\]
...
.nota\[`r paste0(mod3[mod3$uid == "mod3_fn_vertical_1", params$lang])`\]
...
???
Observa cómo los nombres de las columnas en `demo` ¡son antiguos! Es porque nuestros cambios aún no se han guardado.
...
???
Explica que hay muchos matices en case\_when() que practicarás en el ejercicio de ruptura
