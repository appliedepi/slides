...
subtitle: 'Introducción al reprex'
author: 'Abril 2024'
...
- Repasar los errores más comunes en los códigos y cómo resolverlos

- Informarse sobre la documentación de ayuda y otros recursos para la codificación

- Publicar un "reprex" (ejemplo reproducible) de un error en el Foro de la Comunidad de Applied Epi

```{r, echo=FALSE, warning=F, message=F}
outline <- dplyr::tribble(
  ~Tiempo, ~Lugar, ~Tema,
  "25 min",   "Sala principal" ,    "Introducción a reprex",
  "2 horas 40 min",   "Sesiones separadas" ,   "Errores comunes; publicar un reprex"
)

outline %>% 
  flextable::qflextable() %>% 
  flextable::add_footer_lines("Toma los descansos necesarios durante el ejercicio")
```

---
# Introducción al reprex

Hoy queremos centrarnos en **cómo obtener ayuda** con código R

Hay muchas formas de obtener ayuda más allá del curso.

- [Manual de R para Epi Aplicada](https://epirhandbook.com/en/)
- [Foro de la Comunidad de Applied Epi](https://appliedepi.org/community/)
...
- [Applied Epi "Help Desk" (centro de ayuda)](support.appliedepi.org) (recibirás cupones al finalizar el curso)
...
- Debe ser **mínimo**:
  - Incluye sólo los datos y el código necesarios para reproducir el problema
- Debe ser **reproducible**:
  - Incluye *todo* el contexto necesario para reproducir el problema
  - Por ejemplo, paquetes, base de datos simplificada, comandos, versión de R utilizada, etc.

Haremos una demostración de cómo crear y publicar un reprex.

¡No te sientas obligado/a a escribir por ahora! Tendrás la oportunidad de crear tu reprex en los ejercicios.
...
# no creo que está renderizando correctamente? 
...
- La prueba es para enseñarte a entender los errores comunes

**Crear un reprex utilizando el análisis del ébola**
...
- Sigue el ejercicio para repasar los errores más comunes y responder a las preguntas de la prueba
- Aprende a obtener ayuda de distintos recursos
- Crea un reprex en el Foro de la Comunidad de Applied Epi en la página de Formación
