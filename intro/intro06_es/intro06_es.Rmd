...
- Repasar los errores más comunes en los códigos de  y cómo resolverlos

- Infórmate sobre la documentación de ayuda y otros recursos para la codificación

- Publica un "reprex" (ejemplo reproducible) de un error en el Foro de la Comunidad de Appliedepi
...
¡No te sientas obligado a escribir por ahora! Tendrás la oportunidad de crear el tu reprex en los ejercicios.
...
- Crea un reprex en el Foro de la Comunidad de Appliedepi en la página de Formación
