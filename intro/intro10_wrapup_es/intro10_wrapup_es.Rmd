...
outline <- dplyr::tribble(
  ...
  "1",   "RStudio, sintaxis básica de R", "Tutorías ilimitadas (material no relacionado con el curso)\n\n\nReservas fuera de horario\nEnlace enviado por correo electrónico",
  "2",   "Limpieza de datos", "",
  ...
  "Post-curso", "Te ayudamos a aplicar R a tu trabajo.\nCupón de 1 hora válido por 6 meses.*", "Mesa de soporte de R",
)
...
- [Sitio web del servicio de soporte](https://appliedepi.org/support/support)
