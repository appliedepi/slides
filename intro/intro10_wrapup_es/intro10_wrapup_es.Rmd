...
outline <- dplyr::tribble(
  ...
  "Post-curso", "Te ayudamos a aplicar R a tu trabajo.\nCupón de 1 hora válido por 6 meses.*", "Revisión del código R",
)
...
- **Revisión del código R:** 6 meses después del curso
...
outline <- dplyr::tribble(
  ~Curso, ~Descripcion,
  "Informes automatizados con Quarto en R","Crea informes automatizados en Word con Quarto. Domina plantillas con diseños y formatos personalizados y, luego, simplifica tu código con parámetros y un flujo de trabajo limpio que escala para múltiples informes.",
