...
**Use `here()` to the file path** as slash-agnostic  
...
*Above, we save the data with the name `surv_raw`.  * 
...
Let's use a mini dataset, named "**`demo`**", to practice some core R functions.  
