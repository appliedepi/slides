...
.footnote[Enroll in our Advanced R Markdown course or see the [Epi R Handbook chapter](https://epirhandbook.com/en/dashboards-with-r-markdown.html)!]
...
# Chunk options
.pull-left[
Adjust chunk "options" inside the `{r }` to set how it displays in the report:  
...
Below, all chunks are set to show no code, warnings, or error messages in the report
