...
* Review outputs and replicate them using R  
...
outline <- dplyr::tribble(
  ~Time, ~Location, ~Topic,
  "15 minutes",   "Main" ,    "Introduction to reprex",
  "2 hours 45 mins",   "Breakouts" ,   "You choose dataset; reprex post" ,
...
Today's session is focused around creating a reprex! 

* Please attempt to post a reprex on the Applied Epi Community Forum
* The exercises will guide you through a reprex review
* You will then have the option to work on a dataset of your choosing
* When you encounter an issue with your data, go to the community forum and post a reprex about your issue! 

Remember, we are here to help, not matter which dataset you are using. 
...
---
# Remember to post a Reprex! 

Our instructors will review your reprex posts and respond with solutions! 
...
* Follow the exercise to review how to create a reprex
* Start working on a dataset of your choosing
* Create a reprex in the Applied Epi Community Forum when you encounter a problem
