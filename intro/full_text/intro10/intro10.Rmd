...
outline <- dplyr::tribble(
  ~Time, ~Location, ~Topic,
  "20 minutes",   "Main" ,    "Introduction to reprex",
...
Today's session is focused around code errors and creating a reprex! 
...
* If you have extra time, you have the option to work on a dataset of your choosing
...
# Datasets available (Extras section)
