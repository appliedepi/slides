...
outline <- dplyr::tribble(
  ~Course, ~Description,
  "Relatórios automatizados com Quarto em R","Crie relatórios automatizados em Word no Quarto. Domine modelos com layouts e formatação personalizados e, em seguida, simplifique seu código com parâmetros e um fluxo de trabalho limpo que escala para vários relatórios.",
