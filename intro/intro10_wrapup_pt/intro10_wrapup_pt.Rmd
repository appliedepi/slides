...
outline <- dplyr::tribble(
  ...
  "Pós-curso", "Ajudamos você a aplicar R no seu trabalho.\nCupom de 1 hora válido por 6 meses.*", "Central de Suporte em R", 
  )
...
* **Revisão de código:** 6 meses pós-curso
...
- [Site do Suporte](https://appliedepi.org/support/support)
