...
surv %>% 
  group_by(hospital) %>% 
  select(case_id,date_onset,date_report,diff, sex,age,age_unit,hospital)
```



.footnote[Note the `groups: hospital`, at the top of the tibble] 
...
```{r summarise_flair, eval=FALSE, include=FALSE}
decorate("summarise") %>%
...
See tips on customization in the [Epi R Handbook chapter on Descriptive tables](https://epirhandbook.com/en/new_pages/tables_descriptive.html#tbl_gt))
]
