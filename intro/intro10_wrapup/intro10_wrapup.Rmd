...
- [Support Portal](https://appliedepi.org/support/support)
...
outline <- dplyr::tribble(
  ~Course, ~Description,
  "Automated reporting with Quarto in R","Build automated Word reports in Quarto. Master templates with custom layouts and formatting, then streamline your code with parameters and a clean workflow that scales to multiple reports.",
