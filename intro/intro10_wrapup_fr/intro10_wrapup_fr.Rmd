...
outline <- dplyr::tribble(
  ...
  "1",   "RStudio, syntaxe R de base", "Unlimited tutoring\non course material\n\n\nAfter-hours booking\nlink provided by email",
...
* **Revue de code :** 6 mois après le cours

* [Forum communautaire](https://community.appliedepi.org/) & [Manuel Epi R](https://epirhandbook.com/en/)
...
- [Site du Support Desk](https://appliedepi.org/support/support)
...
outline <- dplyr::tribble(
  ~Course, ~Description,
  "Rapports automatisés avec R","Build automated Word reports in Quarto. Master templates, layouts, and tables, then streamline your code with parameters and a clean workflow that scales to multiple reports.",
  "Introduction aux SIG dans R","Create GIS-informed maps and basic spatial analyses in R, from data prep to interactive outputs.",
  "Introduction aux statistiques dans R","Build reproducible R code for descriptive stats, key tests, and regression with strong reporting outputs.",
  "Analyse de séries temporelles et détection d’épidémies dans R","Apply R-based time series methods for surveillance, from data QC to modeling and outbreak-relevant interpretation.",
  "Shiny dans R","Créez des applications Shiny d’introduction pour l’épidémiologie, avec réactivité, interface dynamique et sorties interactives."
  )
