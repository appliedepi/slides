...
outline <- dplyr::tribble(
  ~Course, ~Description,
  "Rapports automatisés avec Quarto en R","Créez des rapports Word automatisés avec Quarto. Maîtrisez les modèles avec des mises en page et une mise en forme personnalisées, puis simplifiez votre code grâce à des paramètres et à un flux de travail clair qui s’adapte à plusieurs rapports.",
