...
outline %>% 
  ...
  flextable::add_footer_lines("Toma descansos como desees duranrte el ejercicio")
```
...
- Listado de casos, véase el diccionario de datos proporcionado en la carpeta del curso
