...
> *"[El manual] entrelaza tantas cosas, de forma tan sucinta y tan increíblemente clara"* <br> - Epidemióloga, CDC de EE.UU.
...
Esta base de datos en R tiene el nombre **`surv`**.
...
La base de datos que queremos utilizar se llama **surv**
