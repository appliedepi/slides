...
```{r, echo=F, eval=T}
surv <- rio::import(xfun::relative_path(here::here("donnees", "linelist_surveillance_nettoyee_20141201.rds")))
# 
...
- **Post-module** Les ressources de l'école : des ressources sont à ta disposition
  ...
  - *Enregistrements* sont sur le lieu du cours
...
Le *rangées* du tableau croisé doivent provenir de la colonne **`sexe`**
...
Le *colonnes* de la table croisée doivent provenir de la colonne **`def_cas`**
...
Sur le lieu du cours, ouvre l'exercice du module 1 et connecte-toi.  
