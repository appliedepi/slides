...
outline <- dplyr::tribble(
  ~Time, ~Location, ~Topic,
  str_glue({paste0(mod1[mod1$uid == "mod4_tb_objectives_1_1", params$lang])}),     str_glue({paste0(mod1[mod1$uid == "mod4_tb_objectives_2_1", params$lang])}),      str_glue({paste0(mod1[mod1$uid == "mod4_tb_objectives_3_1", params$lang])}),
  str_glue({paste0(mod1[mod1$uid == "mod4_tb_objectives_1_2", params$lang])}),     str_glue({paste0(mod1[mod1$uid == "mod4_tb_objectives_2_2", params$lang])}),      str_glue({paste0(mod1[mod1$uid == "mod4_tb_objectives_3_2", params$lang])}),
  str_glue({paste0(mod1[mod1$uid == "mod4_tb_objectives_1_3", params$lang])}),     str_glue({paste0(mod1[mod1$uid == "mod4_tb_objectives_2_3", params$lang])}),      str_glue({paste0(mod1[mod1$uid == "mod4_tb_objectives_3_3", params$lang])}),
  str_glue({paste0(mod1[mod1$uid == "mod4_tb_objectives_1_4", params$lang])}),     str_glue({paste0(mod1[mod1$uid == "mod4_tb_objectives_2_4", params$lang])}),      str_glue({paste0(mod1[mod1$uid == "mod4_tb_objectives_3_4", params$lang])})
)

outline %>% 
  flextable::qflextable() %>% 
  flextable::add_footer_lines(str_glue({paste0(mod1[mod1$uid == "mod4_tb_objectives_4_1", params$lang])}))
```
