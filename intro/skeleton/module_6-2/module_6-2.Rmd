...
```{r,eval = params$lang == "ua", results = "asis", echo = FALSE}
"Загальна формула: scale_aesthetic_method()" %>%
  flair("scale", color = "darkgreen") %>%
  flair("aesthetic", color = "cornflowerblue") %>%  
  flair("method", color = "deeppink") %>%
  flair_all(before = "<h4>", after = "</h4>") %>%
...
```{r, eval = params$lang == "es", results = "asis", echo = FALSE}
"2) aesthetic: _fill_ o _color_ o _x_ o _y_ etc." %>%
  flair("scale", color = "darkgreen") %>%
  flair("aesthetic", color = "cornflowerblue") %>%  
  flair("method", color = "deeppink") %>%
  flair_all(before = "<h4>", after = "</h4>") %>%
...
```{r , echo = FALSE, eval = params$lang == "ua", tidy = FALSE}
ggplot(
  data = surv,
  mapping = aes(
    x = date_onset,
