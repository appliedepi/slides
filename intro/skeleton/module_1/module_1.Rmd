...
## `r paste0(mod1[mod1$uid == "mod1_h2_useful", params$lang])`   
...
* Write basic R code to load packages, use functions, save objects, and perform calculations  
