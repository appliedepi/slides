...
```{r dplyr-flex-fr, echo=params$lang == "fr"}
surv %>% 
  group_by(hospital) %>% 
  summarise(
    n_rows  = n(),                               # n(): le nombre de lignes par groupe
...
```{r dplyr-flex-ru, echo=params$lang == "ru"}
surv %>% 
  group_by(hospital) %>% 
  summarise(
    n_rows  = n(),                               # n(): le nombre de lignes par groupe
