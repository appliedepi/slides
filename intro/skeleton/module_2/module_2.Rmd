...
outline <- dplyr::tribble(
  ~Time, ~Location, ~Topic,
  str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_1_1", params$lang])}),     str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_2_1", params$lang])}),      str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_3_1", params$lang])}),
  str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_1_2", params$lang])}),     str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_2_2", params$lang])}),      str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_3_2", params$lang])}),
  str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_1_3", params$lang])}),     str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_2_3", params$lang])}),      str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_3_3", params$lang])}),
  str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_1_4", params$lang])}),     str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_2_4", params$lang])}),      str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_3_4", params$lang])}),
  str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_1_5", params$lang])}),        str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_2_5", params$lang])}), str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_3_5", params$lang])})
)

outline %>% 
  flextable::qflextable() %>% 
  flextable::add_footer_lines(str_glue({paste0(mod1[mod1$uid == "mod2_tb_session_4_1", params$lang])}))
```
...
* `r paste0(mod1[mod1$uid == "mod2_bu_Rproject_1", params$lang])`  
* `r paste0(mod1[mod1$uid == "mod2_bu_Rproject_2", params$lang])`  
* `r paste0(mod1[mod1$uid == "mod2_bu_Rproject_3", params$lang])`  
* `r paste0(mod1[mod1$uid == "mod2_bu_Rproject_4", params$lang])`
