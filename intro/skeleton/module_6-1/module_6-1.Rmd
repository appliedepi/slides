...
ggplot(
  data = surv,        # використання лінійного списку
  mapping = aes(      # створення естетичного відображення для всіх геомів
    x = age_years,    # присвоєння осі x стовпцю віку
    y = ht_cm)) +     # присвоєння осі y росту
geom_point()          # відображення даних у вигляді точок
```
...
color_purple <- ggplot(data = surv, aes(x = age_years, y = ht_cm))+
  geom_point(color = "purple")+
  theme_minimal(base_size = 16)+
  labs(title = "Використання кольору = 'purple' (бузковий)")
...
color_hospital <- ggplot(data = surv, aes(x = age_years, y = ht_cm))+
  geom_point(aes(color = hospital))+
  theme_minimal(base_size = 16)+
  labs(title = "Використання aes(color = hospital), лікарня")
...
fill_purple <- ggplot(data = surv, aes(x = date_onset))+
  geom_histogram(fill = "purple")+
  theme_minimal(base_size = 16)+
  labs(title = "Використання fill = 'purple' (бузковий)")


fill_hospital <- ggplot(data = surv, aes(x = date_onset))+
  geom_histogram(aes(fill = hospital))+
    theme_minimal(base_size = 16)+
  labs(title = "Використання aes(fill = hospital) (лікарня)")
