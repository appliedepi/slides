...
subtitle: "More public health visualizations with {ggplot2}"
author: "2022"
...
4) `r emo::ji("check")`**Modify "scales"**, such as a color scale or y-axis breaks  

--

5) `r emo::ji("check")`**Add "theme" plot design elements** such as axis labels, title, caption, fonts, text sizes, background themes, or axes rotation  
