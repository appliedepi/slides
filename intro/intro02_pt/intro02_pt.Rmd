...
**`surv_raw`** ainda tem os *nomes das colunas originais*!
...
**`surv_clean`** tem os *nomes de colunas limpos*!
...
O `class()` das colunas de data deve ser "date", não "character".
