...
- Start installing and loading R packages using {pacman} and {baseR}
...
- She suggests that you keep working in the same folder: GIoutbreak. 
- Let's take a look!
...
- It's now *10 days* later. There is new clinic data **and** now lab data. 
...
- You have downloaded the data and put it in the 'Data' folder of your project.
   - The updated file: **GIoutbreak_2021-06-05_linelist.csv** 
   - The laboratory results: **GIoutbreak_2021-06-05_lab.xlsx**
