...
- Start navigating the RStudio interface
- Understand how to run and write code and manage objects in RStudio
- Understand how to install and load R packages, including using pacman::p_load().
- Know how to create and organize R scripts with comments 
