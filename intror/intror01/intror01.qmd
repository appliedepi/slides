...
-   *Understand power of R code*: reproducibility, time saving and efficiency, collaboration, scalability, and quality of outputs
-   *Understand what code is*: Instructions to the computer to process inputs and make outputs
-   *Understand what functions are*: Specific instructions in words
-   *Understand what assigning is*: Storing inputs or outputs as objects so R can use them later
-   *Get acquainted with running code*: You did!
