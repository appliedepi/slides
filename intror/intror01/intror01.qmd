...
- Junior colleagues have been manually cleaning data. Your colleague, Pragya was then creating situation reports (sitreps) using R.

- Her reporting processes allows her to click a button to create a whole report with tables, figures, and text!
