...
-   *You*: You are an epidemiologist working in a surveillance unit
    located in the country **Viralad**
...
R requires that object names: - Start with a letter, not a number - Do
not contain any spaces

It is best practice that column names: - Do not contain special
characters other than underscores or periods - Be short and easy to
understand - Do not have the same name as an existing function
:::
