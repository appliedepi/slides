...
- Understand and develop code for creating more advanced maps, including Chloropleth maps, Heat maps, and Interactive maps. 
...
outline <- dplyr::tribble(
  ...
  "5",   "Chloropleth maps",
  "6",   "Introduction to Spatial Analaysis (Day 2)", 
  "7",   "Nearest neighbour analysis",
  "8",   "Buffery analysis",
  "9",   "Heat maps and interactive maps",
...
outline <- dplyr::tribble(
  ...
  "45 minutes",     "Main",      "Lecture 1: Introduction to GIS for R",
...
#Add example simple ggplot of map with points
