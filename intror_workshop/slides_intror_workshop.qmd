...
* Apply these functions to investigate a real-world outbreak scenario
...
You've set up a report in R, and this week's data has been updated. You need to produce an updated report with case counts, demographic and geographic breakdowns, epicurves, etc, both as a word document, and a powerpoint output/
...
Here are some key functions for epidemiological tasks. In RStudio, you would download a *{package}* containing these functions.
...
df <- import(here::here("intror_workshop/data/Viraland_cholera_2021-05-25_linelist_clean_demo.rds"))
