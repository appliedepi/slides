...
There is not enough time in a week to teach both statistics and R, and so we will be focusing on taking your existing knowledge and showing you how to apply this to R.

---
# What we will be covering

- Exploring your data and basic hypothesis testing.
- Univariate, Stratified and Multivariate regression (with a focus on logistic regression).
...
- Understand how to carry out variable selection and run multivariate regression analysis, with and without interaction terms and random effects
...
- We use this term to indicate the use of a test that explores the relationship between an outcome and a variable and returns an indication (a p-value) of whether or not there is a relationship.
...
```{r, eval = F, echo = T}
linelist %>%
    select(gender, outcome, vomit, cough) %>%
